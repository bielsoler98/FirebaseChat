package com.senyor_o.firebasechat.di
...
import com.senyor_o.firebasechat.data.repository.AuthRepositoryImpl
import com.senyor_o.firebasechat.data.repository.FirestoreRepositoryImpl
...
class AppModule {
    ...
    @Provides
    fun provideFirebaseFirestoreStorage() = Firebase.storage
